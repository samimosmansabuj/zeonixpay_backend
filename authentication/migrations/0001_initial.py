    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('bkash', 'bkash'), ('bkash-agent', 'bkash-agent'), ('bkash-personal', 'bkash-personal'), ('nagad', 'nagad'), ('nagad-agent', 'nagad-agent'), ('nagad-personal', 'nagad-personal'), ('rocket', 'rocket'), ('rocket-agent', 'rocket-agent'), ('rocket-personal', 'rocket-personal'), ('bank', 'bank'), ('crypto', 'crypto')], max_length=20)),
